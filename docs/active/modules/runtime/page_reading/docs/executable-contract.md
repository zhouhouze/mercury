...
- `docs/active/project/07-data-models.md`
...
- `HighSignalPageContext` validates against `docs/active/project/contracts/a_v1_1_high_signal.schema.json` for compatibility and against A-V1.2 public schema where applicable.
